...
keywords = {
    ...
    "لاته": ["اسپرسو را با مقدار بیشتری شیر بخار داده شده و کمی کف شیر ترکیب کنید. 🍶☕"],
    "ماکیاتو": ["اسپرسو را با کمی کف شیر روی آن آماده کنید. 🍂"],
    "آمریکانو": ["اسپرسو را با آب داغ ترکیب کنید. 🌊"],
    "موکا": ["اسپرسو، شیر بخار داده شده و شکلات داغ را ترکیب کنید. 🍫"],
    "آیس کافی": ["قهوه سرد شده را با یخ و شیر یا شکر ترکیب کنید. 🧊☕"],
    "فرپه": ["قهوه فوری، یخ و شیر را در مخلوط‌کن ترکیب کنید. 🍦☕"],
    "چای لاته": ["چای ماسالا را با شیر بخار داده شده ترکیب کنید. 🍵"],
    "هات چاکلت": ["شکلات داغ را با شیر بخار داده شده ترکیب کنید. 🍫🥛"],
    "آیس موکا": ["موکا را سرد کرده و با یخ سرو کنید. 🧊🍫"],
    "ماچا لاته": ["پودر ماچا را با شیر بخار داده شده ترکیب کنید. 🍵🥛"],
    "آیس ماچا": ["ماچا را با یخ و شیر سرد ترکیب کنید. 🧊🍵"],
    "کارامل ماکیاتو": ["اسپرسو، شیر بخار داده شده و کارامل را ترکیب کنید. 🍯☕"],
    "آیس کارامل ماکیاتو": ["نسخه سرد کارامل ماکیاتو با یخ. 🧊🍯"],
    "آفوگاتو": ["یک اسکوپ بستنی وانیلی را با اسپرسو داغ ترکیب کنید. 🍨☕"],
    "قهوه ترک": ["قهوه آسیاب شده را با آب و شکر در جذوه بجوشانید. 🇹🇷☕"],
    "قهوه فرانسه": ["قهوه آسیاب شده را با فرنچ پرس دم کنید. 🇫🇷☕"],
    "شیک اسپرسو": ["اسپرسو، یخ و شکر را در شیکر ترکیب کنید. 🍹"],
    "لیموناد قهوه": ["اسپرسو را با آب لیمو و یخ ترکیب کنید. 🍋☕"]
}
