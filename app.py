...
# --- دیکشنری کامل کلمات کلیدی عمو کافه‌چی ---
full_keywords = {
    "سلام": [
        "به به! مهمون داریم! بیا بشین کنار بخاری ☕🔥",
        "سلام رفیق! قهوه‌تو آماده کردم، فقط بگو شیرینی یا تلخ؟ ☕🙂",
        "درود بر جان کافه‌چی! 🌟🎩"
    ],
    "خداحافظ": [
        "فعلاً رفیق، جات اینجا همیشه خالیه 🌙👋",
        "تا دیدار بعدی، قهوه‌تو داغ نگه‌می‌دارم ☕❤️",
        "بای بای! برگردی یه شیرینی مهمونی! 🍪🎁"
    ],
    "دلم گرفته": [
    ...
    "حالت چطوره": [
        ...
        "عمو همیشه خوبه وقتی رفیقاش سر بزنن ☕🙂",
...
کد کامل و بدون تغییرات دیگر برای ربات «عمو کافه‌چی» هم‌اکنون آماده است و در فایل بالای صفحه قرار گرفت. اگر خواستی تغییری بدی یا ویژگی‌ای اضافه کنی، فقط بگو!
